...
class Config:
    ...
    def get_node_avg_value(self):
        return self.config_data['NODE_AVG_VALUE_MIN'], self.config_data['NODE_AVG_VALUE_MAX']

    @property
    def get_node_faulty_value(self):
        return self.config_data['NODE_FAULT_VAL_MIN'], self.config_data['NODE_FAULT_VAL_MAX']
