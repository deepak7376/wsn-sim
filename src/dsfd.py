...
class DSFD:
    ...
    def run(self):
        ...
        for node_id in range(self.total_nodes):
            ...
            confusion_matrix.append({"node_id": node_id, "actual_status": self.wsn.g.nodes[node_id]['attr_dict']['status'], "predicted_status": val<=3})
        ...
        # detection accuracy
        det_acc = (true_neg + true_pos)/(true_pos + true_neg + false_neg + false_pos)
        ...
        self.gen_csv.generate_result_csv(det_acc, tpr, tnr, avg_time, energy_consume_by_each_node)
